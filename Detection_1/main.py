...
scene_id = 'j_005'
object_name = 'BigBottle'  # 'BigBottle' or 'MediumBottle' as of now # Todo add more
...
OBJECT_PATHS = {  # Todo add more
    ...
    'SmallBottle': 'objects/SmallBottle/SmallSoyBroth_Bottle_small.ply'
}
...
if __name__ == "__main__":
    ...
    for rgb_idx, rgb_path in enumerate(rgb_paths):
        ...
        #img_mask_path = [mask_path for mask_path in img_mask_paths
        #                 if mask_path.split('.')[-2].split(split_at)[-1].split('_')[0] == object_name] # p_020
        ...
        edge_image = img_edge_prediction(img, img_mask, rgb_idx, object_name, H_I_C, H_C_O_mod_torch.detach(),
                                         intrinsics, kernel_width=11, kernel_width2=11)  # todo variables
        ...
        if save:
            ...
            liquidmask_path = os.path.join("output_img", object_name, f"prediction{rgb_idx + 1}.png")
